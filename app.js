...
fetch("data.json")
  .then(r => r.json())
  .then(data => {
    renderDirection("anada-content", "loading-anada", "Manresa - Barcelona", data);
    renderDirection("tornada-content", "loading-tornada", "Barcelona - Manresa", data);
  })
  .catch(() => {
    document.getElementById("loading-anada").textContent = "Error carregant dades.";
    document.getElementById("loading-tornada").textContent = "Error carregant dades.";
  });
